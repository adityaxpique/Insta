...
class _FeedScreenState extends State<FeedScreen> {
  ...
  Widget _buildPostHimanshu(int index) {
    return Padding(
  ...
  Widget _buildPostAditya(int index) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: 10.0, vertical: 5.0),
      child: Container(
        width: double.infinity,
  ...
  Widget _buildPostKiran(int index) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: 10.0, vertical: 5.0),
      child: Container(
        width: double.infinity,
  ...
  Widget _buildPostKhyati(int index) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: 10.0, vertical: 5.0),
      child: Container(
        width: double.infinity,
  ...
  Widget _buildPostAditi(int index) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: 10.0, vertical: 5.0),
      child: Container(
        width: double.infinity,
  ...
  Widget _buildPostHarshita(int index) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: 10.0, vertical: 5.0),
      child: Container(
        width: double.infinity,
  ...
  Widget _buildPostHarsh(int index) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: 10.0, vertical: 5.0),
      child: Container(
        width: double.infinity,
  ...
  Widget _buildPostAnmol(int index) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: 10.0, vertical: 5.0),
      child: Container(
        width: double.infinity,
  ...
  Widget _buildPostAbhishek(int index) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: 10.0, vertical: 5.0),
      child: Container(
        width: double.infinity,
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          _buildPostAditya(0),
          _buildPostHimanshu(1),
          _buildPostAJ(2),
          _buildPostKhyati(3),
          _buildPostKiran(4),
          _buildPostAditi(5),
          _buildPostHarshita(6),
          _buildPostHarsh(7),
          _buildPostAnmol(8),
          _buildPostAbhishek(9),
